...
<%@ page import="com.article.servlet.page.*"%>
...
<html>
	...
	<body>
		...
		<br/>
		<FORM name="queryForm" METHOD="POST" action="/luceneTest/queryDB">
			请输入SQL语句：
			...
			<%if (hasResult) {%>
			<FORM name="pageForm" METHOD="POST" action="/luceneTest/db/queryDB.jsp">
