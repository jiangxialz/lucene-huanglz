...
//            strPath = Config.IndexPath;
     ...
     * @throws Exception
     */
  public <T> DataGrid<List<T>> search(T object, String strQueryString, int offset, int limit, String strSorts, List<T> resultList) throws Exception
  {
	  /**
...
//      }  
      ...
      */
      return search(object, strQueryString, offset, limit, strSorts, null, resultList);
  }
...
public <T> DataGrid<List<T>> search(T object, Query query, int offset, int limit, String strSorts, List<T> resultList)
{
      ...
      try
      {
          ...
          if (query == null)
              ...
              // 对索引中的字段进行查询
	          TopDocs topDocs = searcher.search(query, null, offset+limit, sort);
 ...
 * @return 
  ...
  private Sort getFieldsSort(String strSorts)
  {
     ...
     */
	  ...
	  public <T> DataGrid<List<T>> search(T object, String strQueryString, int offset, int limit, String strSorts, Analyzer analyzer, List<T> resultList)
	  throws Exception
	  {
			...
			return search(object, query, offset, limit, strSorts, resultList);
	 }
