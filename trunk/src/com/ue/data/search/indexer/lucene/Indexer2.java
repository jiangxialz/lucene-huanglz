...
public class Indexer2 implements IInderer
{
	 // 配置管理类实例
    ...
    public static Indexer2 newInstance(Properties properties) throws Exception
    {
        Indexer2 indexer = new Indexer2(properties);
    ...
    public Indexer2(Properties properties)
    {
        m_properties = properties;
    }

    public Indexer2(String strPath, Properties properties)
    {
        if (strPath == null)
...
//            strPath = Config.IndexPath;
     ...
     * @throws Exception
     */
  public DataGrid<JSONArray> search(String strQueryString, int offset, int limit, String strSorts) throws Exception
  {
	  /**
...
public DataGrid<JSONArray> search(Query query, int offset, int limit, String strSorts)
{
	  DataGrid<JSONArray> dataGrid = new DataGrid<JSONArray>();
...
//	                	  jsonObject.add(strField, document.get(strField));
	                  }
  ...
  private Sort getFieldsSort(String strSorts)
  {
     ...
     */
	  ...
	  public DataGrid<JSONArray> search(String strQueryString, int offset, int limit, String strSorts, Analyzer analyzer)
	  throws Exception
	  {
